...
globalThis.TileMessages = {
  "ru": {
    ...
    "tile.simplified": "Мелкие детали были сокращены, чтобы получить надёжную физическую раскладку.",
  ...
  "en": {
    ...
    "tile.simplified": "Fine details were reduced to produce a reliable physical layout.",
  ...
  "zh": {
    ...
    "tile.simplified": "已减少细节，以生成可靠的实体布局。",
